...
public class Player {
    ...
    private String color;        // don't want to change after initialization
    private Color playerColor; //Added this data member so that we can change the route color based on the player's color
